...
AS '
	...
	, REQUISITOS AS (
	    ...
	    FROM LOE_SCRRTST
	    		--LEFT JOIN UPN_RPT_DM_DEV.ODSMGR.COURSE_CATALOG ON SCRRTST_TERM_CODE_EFF = ACADEMIC_PERIOD AND SCRRTST_SUBJ_CODE_PREQ = SUBJECT AND SCRRTST_CRSE_NUMB_PREQ = COURSE_NUMBER
