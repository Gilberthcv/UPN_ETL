...
CREATE OR REPLACE VIEW SMRDORQ AS SELECT * FROM BI_CDW_PROD.UPN_STG_SIS_BNRODS_ODSMGR.SMRDORQ;
...
CREATE OR REPLACE VIEW SMRDORQ AS SELECT * FROM UPN_RPT_DM_PROD.SATURN.SMRDORQ;
